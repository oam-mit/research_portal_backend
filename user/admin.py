...
class ProjectAdmin(admin.ModelAdmin):
    ...
    fieldsets = [
        (('Basic Information'), {
         'fields': ('faculty', 'title', 'description', 'outcome')}),
        (('Tags (Separate tags with comma)'), {'fields': ('tags',)}),
        (('Control Information'), {'fields': ('is_department_specific', 'is_extendable',
         'max_students', 'start_date', 'end_date', 'hours_per_week', 'is_active')}),
    ]
