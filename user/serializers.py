...
class UserSerializer(serializers.ModelSerializer):
    ...
    registration_number=serializers.CharField(source='student.registration_number')
    ...
    class Meta:
        model=User
        fields=['email','first_name','last_name','department','is_student','is_faculty','registration_number','cv','profile_picture']
